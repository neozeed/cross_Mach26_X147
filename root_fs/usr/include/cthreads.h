 ...
 * HISTORY
 * $Log:	cthreads.h,v $
 * Revision 1.2  90/11/10  14:37:41  bww
 * 	Changed declaration of chtread_init() from void to
 * 	int to agree with the Mach 3.0 cthreads package.
 * 	From "[90/11/02            mrt]" at CMU.
 * 	Removed the debugging macros from here as they were
 * 	conflicting with things that other programs defined.
 * 	From "[90/08/17            mrt]" at CMU.
 * 	[90/11/10  14:36:43  bww]
 * 
