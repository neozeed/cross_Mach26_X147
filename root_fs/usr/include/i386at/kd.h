 ...
 * HISTORY
 * $Log:	kd.h,v $
 * Revision 1.2  91/06/18  17:30:30  slatteng
 * 	The real difference `tween EGA/CGA/VGA/MONO registers is color or not
 * 	[91/06/18  17:29:43  slatteng]
 * 
 * Revision 1.1  91/05/09  13:42:44  jaap
 ...
 */
#define COLOR_IDX_REG	0x3d4
#define COLOR_IO_REG	0x3d5
...
#define KDSETBELL	_IOW('k', 4, int)		/* turn bell on/off */
#else
#define KDGKBENT	_IOWR(k, 1, struct kbentry) /* get keybd entry */
#define KDSKBENT	_IOW(k, 2, struct kbentry) /* set keybd entry */
#define KDGSTATE	_IOR(k, 3, int)	/* get keybd state */
